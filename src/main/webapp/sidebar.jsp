    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            <li style="padding: 10px 0 0;">
                <a href="${pageContext.request.contextPath}/dashboard" class="waves-effect"><i class="fa fa-clock-o fa-fw"
            ...
            <li>
                <a href="${pageContext.request.contextPath}/profile" class="waves-effect"><i class="fa fa-user-circle fa-fw"
